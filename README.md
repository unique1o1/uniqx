...
```bash
$ curl -fsSL https://github.com/unique1o1/jprq-go-client/releases/download/1.0.0/jprq-linux_amd64.tar.gz > jprq-linux_amd64.tar.gz && tar -xvf jprq-linux_amd64.tar.gz
